...
void mapAllPins() {
   ...
   PORTC->GPCLR = ForceLockedPins|0x0100UL|PORT_GPCLR_GPWE(0x0006UL);
   PORTC->GPCLR = ForceLockedPins|0x0200UL|PORT_GPCLR_GPWE(0x00E0UL);
   PORTC->GPCLR = ForceLockedPins|0x0300UL|PORT_GPCLR_GPWE(0x0018UL);
   ...
   if constexpr (ForceLockoutUnbondedPins) {
      ...
      PORTB->GPCLR = PinLock_Locked |0x0000UL|PORT_GPCLR_GPWE(0xFFFCUL); // Lockout unavailable pins
      PORTB->GPCHR = PinLock_Locked |0x0000UL|PORT_GPCHR_GPWE(0xFFFFUL); // Lockout unavailable pins
      PORTC->GPCLR = PinLock_Locked |0x0000UL|PORT_GPCLR_GPWE(0xFF01UL); // Lockout unavailable pins
      PORTC->GPCHR = PinLock_Locked |0x0000UL|PORT_GPCHR_GPWE(0xFFFFUL); // Lockout unavailable pins
      PORTD->GPCLR = PinLock_Locked |0x0000UL|PORT_GPCLR_GPWE(0xFF0FUL); // Lockout unavailable pins
