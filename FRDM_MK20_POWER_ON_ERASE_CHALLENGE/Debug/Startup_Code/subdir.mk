...
Startup_Code/%.o: ../Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -g3 -O0 -ffunction-sections -fdata-sections -x assembler-with-cpp -I"C:/Users/Peter/Documents/Development/USBDM/usbdm-eclipse-makefiles-build/FRDM_MK20_POWER_ON_ERASE_CHALLENGE/Project_Headers" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
