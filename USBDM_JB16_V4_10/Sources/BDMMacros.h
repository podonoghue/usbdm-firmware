...
#define BDM_CMD_1W1B_0_T(cmd, parameter1, parameter2) \
   (bdm_txPrepare(),\
   bdmTx(cmd),\
   bdmTx((U8)(((parameter1)>>8)&0xFF)),\
   bdmTx((U8)((parameter1)&0xFF)),\
   bdmTx((U8)((parameter2)&0xFF)) \
   /*,enInterrupts()*/)
   // NO bdm_txFinish()
...
#define BDM_CMD_1L_0(cmd,parameter) \
   (bdm_txPrepare(),\
   bdmTx(cmd),\
   bdmTx((U8)((parameter)>>24)&0xFF),\
   bdmTx((U8)((parameter)>>16)&0xFF),\
   bdmTx((U8)((parameter)>>8)&0xFF),\
   bdmTx((U8)((parameter)&0xFF)),\
   DO_ACKN_WAIT64())
...
#define BDM_CMD_1A1L_0(cmd, addr, value) \
   ...
   bdmTx((U8)((addr)>>8)&0xFF),\
   bdmTx((U8)((addr)&0xFF)),\
   bdmTx((U8)((value)>>24)&0xFF),\
   bdmTx((U8)((value)>>16)&0xFF),\
   bdmTx((U8)((value)>>8)&0xFF),\
   bdmTx((U8)((value))&0xFF),\
   DO_ACKN_WAIT150())
