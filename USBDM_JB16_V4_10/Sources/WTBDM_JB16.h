/*! @file
    @brief This file contains hardware specific information and configuration for "Witztronics WTBDMS08/S12".
    
    USBDM - Universal BDM, JB16 Version \n
    Based on Witztronics WTBDMS08/S12, 27-Jul-2007, see
    @htmlonly <a href="WTBDMS08.pdf">schematic</a> @endhtmlonly \n
...
#define ProductDescription "USBDM - JB16, Witztronics, Version " VERSION_STR
//=================================================================================
...
#define USBPUP PUP_OFF // No internal pull-up (external PUP present)
...
//
// NOTE: The use of LVC45 buffers creates problems with unavaildable glitches/conflicts
//
...
// RESET data direction pin
#define RESET_DIR         PTC_PTC1
#define RESET_DIR_DDR     DDRC_DDRC1

#define RESET_IS_HIGH       (RESET_IN!=0)
#define RESET_IS_LOW        (RESET_IN==0)

// RESET buffer enable/direction control varies with driver
#define RESET_LOW()       (RESET_DIR=1,RESET_DIR_DDR=1,RESET_OUT=0,RESET_OUT_DDR=1)
#define RESET_3STATE()    (RESET_OUT_DDR=0,RESET_OUT=0,RESET_DIR=0,RESET_DIR_DDR=1)
...
#define RED_LED_MASK    (PTD_PTD1_MASK) // Dummy - unused pin
