/**
 * @file      pin_mapping.h (generated from MKL05Z4.usbdmHardware)
 * @version   1.3.0
 * @brief     Peripheral declarations for FRDM_KL05Z
 *
 * *****************************
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   4: GPIOB_4              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   5: GPIOB_5              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         ...
         /*  12: GPIOB_12             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  13: GPIOB_13             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  14: GPIOB_14             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  15: GPIOB_15             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr uint32_t osc_clock = 32769UL;

   //! Frequency of 32K OSC Clock or Crystal (if applicable)
   static constexpr uint32_t osc32k_clock = 32769UL;
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: XTAL0                = PTA4(XTAL0)                    */  { PortAInfo,  4,            (PcrValue)0x00000UL  },
         /*   1: EXTAL0               = PTA3(EXTAL0)                   */  { PortAInfo,  3,            (PcrValue)0x00000UL  },
   };
...
public:
   ...
   static constexpr uint32_t rtcclk_clock = 32769UL;
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: XTAL32               = PTA4(XTAL0)                    */  { PortAInfo,  4,            (PcrValue)0x00000UL  },
         /*   1: EXTAL32              = PTA3(EXTAL0)                   */  { PortAInfo,  3,            (PcrValue)0x00000UL  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   4: ADC0_SE4             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   5: ADC0_SE5             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   6: ADC0_SE6             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   7: ADC0_SE7             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   8: ADC0_SE8             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   9: ADC0_SE9             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  10: ADC0_SE10            = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  11: ADC0_SE11            = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: RESET_b              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   2: SWD_DIO              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: I2C0_SCL             = PTB3(D15/I2C_SCL)              */  { PortBInfo,  3,            (PcrValue)0x00220UL  },
         /*   1: I2C0_SDA             = PTB4(D14/I2C_SDA)              */  { PortBInfo,  4,            (PcrValue)0x00220UL  },
   };
...
PORTB->GPCLR = 0x0220UL|PORT_GPCLR_GPWE(0x0018UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: VDD                  = VDD(VDD)                       */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: VREFH                = VREFH(VREFH)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   2: VREFL                = VREFL(VREFL)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   3: VSS                  = VSS(VSS)                       */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: SPI0_PCS             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: UART0_TX             = PTB1(D1/ConsoleTx)             */  { PortBInfo,  1,            (PcrValue)0x00200UL  },
         /*   1: UART0_RX             = PTB2(D0/ConsoleRx)             */  { PortBInfo,  2,            (PcrValue)0x00200UL  },
   };
...
PORTB->GPCLR = 0x0200UL|PORT_GPCLR_GPWE(0x0006UL);
   }
