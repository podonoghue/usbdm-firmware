...
using Led1  = ---Symbol not found or format incorrect for substitution '/**
 ============================================================================
 * @file  pit-example2.cpp (180.ARM_Peripherals/Snippets/pit-example2-MKL.cpp)
 * @brief Programmable Interrupt Timer (PIT) Example
 *
...
' => key='demo.cpp.red.led', def='USBDM', mod=':GpioB<18, ActiveLow>';
using Led2  = ---Symbol not found or format incorrect for substitution '/**
 ============================================================================
 * @file  pit-example2.cpp (180.ARM_Peripherals/Snippets/pit-example2-MKL.cpp)
 * @brief Programmable Interrupt Timer (PIT) Example
 *
...
' => key='demo.cpp.green.led', def='USBDM', mod=':GpioB<19, ActiveLow>';
